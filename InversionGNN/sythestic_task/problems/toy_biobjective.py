...
if __name__ == '__main__':
    ...
    plt.rcParams["figure.figsize"] = (2.25, 1.8)  
    ...
    with lp.figure('epo'):
        ...
        add_interval(axt, (-.95, .95), (0.02, 0.02), "g", "()", r"$- \mathbf{1} / \sqrt{n} \preceq  \theta^0 \preceq  \mathbf{1} / \sqrt{n}$", side="both")
        add_interval(axt, (-3, -1.05), (0.02, 0.02), "r", "()", r"$\theta^0 \preceq  - \mathbf{1} / \sqrt{n}$ or " + r"$\theta^0 \preceq  \mathbf{1} / \sqrt{n}$", side="right")
